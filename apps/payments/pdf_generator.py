...
def generate_receipt_pdf(payment):
    """
    Generates a professional PDF digital receipt for a Mehran WiFi Service payment.
    ...
    header_data = [
        [
            Paragraph("<b>MEHRAN WIFI SERVICE</b><br/><font size=8 color='#64748B'>High-Speed Fiber Optic Internet Provider<br/>NOC Support: 03454524086 | support@mehranwifi.com</font>", title_style),
    ...
    customer_address = user_profile.address if user_profile and user_profile.address else "Mehran Service Area"
    ...
    stamp_text = """
    <b>OFFICIAL DIGITAL RECEIPT - MEHRAN WIFI SERVICE</b><br/>
...
def generate_history_pdf(user, subscriptions):
    ...
    # Header
    title = Paragraph("<b>MEHRAN WIFI SERVICE</b><br/><font size=10 color='#64748B'>Customer Package History & Account Statement</font>", ParagraphStyle('H1', parent=styles['Heading1'], fontName='Helvetica-Bold', fontSize=18, leading=22))
    ...
    note = "This statement is automatically generated by Mehran WiFi Service Management System. NOC Hotline: 03454524086"
